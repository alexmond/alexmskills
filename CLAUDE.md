...
- 2026-07-03 — **prompt-coach-daily-review** — 0.21.0/0.22.0: `/prompt-coach-beta:daily-review` reads every repo's log.md under a search root + watermark for "since last review". Why: cross-repo temporal analytics daily.
