...
- 2026-08-28 — **live-session-demo** — brainstorm-panel 1.3.1: first REAL recorded-session demo (12 takes); full take-by-take playbook in docs/decisions/2026-08-28-live-session-recording-findings.md. Why: interactivity, not timing, is what breaks scripted recordings.
