...
The main session is the conductor. Work locally while lanes run; after a wait timeout reconcile missing reports using available agent status tools. Send follow-ups to existing lanes before considering replacement. Preserve verdict reading, all four deviation shapes, and the measured width ceiling.
