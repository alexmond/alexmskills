...
Keep the roster approval gate before spawning. Seat independence, rounds, skeptic review, and the shared panel log are unchanged. Apply model overrides only through supported parameters.
