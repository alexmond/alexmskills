...
Use the actual client for optional generated-by attribution. Do not attach a
Claude identity or invented Codex co-author email to a Codex commit/PR. Preserve
repository attribution requirements and the full issue, verification and PR flow.
