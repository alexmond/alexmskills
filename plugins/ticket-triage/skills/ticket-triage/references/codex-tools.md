...
Keep one worktree per ticket lane and the measured width ceiling. Correct an existing worker through messaging/follow-up, then reconcile after waits. Worktree isolation is still git's, not the agent runtime's.
