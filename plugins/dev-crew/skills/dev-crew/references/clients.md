...
Read `codex-tools.md` before dispatch. The Codex PreToolUse hook checks handoff
files when spawning crew roles. Include the exact `dc-*` role in every dispatch
message/task name. The same contract, BLOCKED and QA FAIL checks apply.
