...
| "analyze this prompt: …" / "was my last prompt good" | `analyze "<text>"` (or `/prompt-coach:analyze`) |
| "analyze my last N prompts" / "how have I been prompting" | `analyze --last N` (or `/prompt-coach:analyze`) |
