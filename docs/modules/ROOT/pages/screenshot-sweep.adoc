...
| Sweep
| Whole-image defect checklist.
| Identical — needs a client that can view images.

|===

*The difference that matters:* The misses log lives in the repo's `.claude/screenshot-sweep/`, so both clients tighten the same checklist.
