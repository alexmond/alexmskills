...
| Hooks
| SessionStart audit, PreToolUse format lint, PostToolUse commit mining, Stop capture, PostCompact audit.
| The same five events through `hooks/codex.json` and the shared adapter. Trust them once with `/hooks`.
