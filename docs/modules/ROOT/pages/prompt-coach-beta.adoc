...
|===
| Command | When to use
| `+/prompt-coach-beta:analyze+` | *"Is this prompt any good?"* Runs the full 34-rule catalog against a pasted prompt or your last N logged prompts, with a coached rewrite / pattern report.
