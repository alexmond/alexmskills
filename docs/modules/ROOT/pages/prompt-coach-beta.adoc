...
| workflow-fanout-no-verify *(v0.43+)* | An orchestrated fan-out (workflow / parallel agents / sweep) to *discover* many items with no adversarial verify + dedup pass — fan-out buys scale, not reliability
|===
