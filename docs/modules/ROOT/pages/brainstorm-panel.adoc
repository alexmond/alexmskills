...
* *Fable suggestion at the roster checkpoint* — because a panel is generation-bound, the lineup now comes
  with an opt-in recommendation to run *one* deep "visionary" generator seat on the Fable tier (the rest
  stay on Opus to preserve diversity), or the skeptic for a harder critique. Always opt-in; never default.
