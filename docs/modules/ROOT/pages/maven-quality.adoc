...
| Skills
| Format, PMD, JaCoCo and pre-commit guidance driving `mvn`.
| Identical — plain instructions and shell commands.

|===

*The difference that matters:* Nothing client-specific. The skills run the same Maven commands on either client.
