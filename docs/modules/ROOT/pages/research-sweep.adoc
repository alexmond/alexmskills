...
* *Fable suggestion at the roster checkpoint* — because a sweep is verification-bound, the roster now
  comes with an opt-in recommendation to run the skeptic-verifier (and optionally the synthesizer) on the
  Fable tier; the coverage scouts stay on Opus. Always opt-in; never default.
