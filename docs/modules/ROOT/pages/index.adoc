...
| xref:competitive-review.adoc[competitive-review]
| Evidence-tiered competitor review: falsifiable hypotheses stated before the research, a claim-tier citation contract, liveness forensics, and a refresh mode that reports what changed.
