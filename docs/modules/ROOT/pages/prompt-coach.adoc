...
| `+/prompt-coach:dashboard+` | *"Show me everything in a browser."* Launches the local xref:#web-dashboard[web dashboard] — stats, mastery, live config editor, the Prompt Library, and the ranked Sources tab.
...
| `+/prompt-coach:library+` | *"Show me a prompt for X."* Matches your task to the closest gold-standard template from xref:#prompt-library[Anthropic's Claude Code Prompt Library].
