...
|---|---|---|---|
| [`evolving-claude-md`](plugins/evolving-claude-md) | self-learning | 1.5.0 | Turns CLAUDE.md into a living Decisions & Learnings log that prunes, graduates, and archives itself via hooks — plus tree-grounded coverage, capture triggers for the never-written-to log (adoption, empty-log, commit mining), layout-drift tracking, and a researched structure-review rulebook. |
