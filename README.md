...
| [`brainstorm-panel`](plugins/brainstorm-panel) | self-learning | 1.3.1 | Assembles a task-fit panel of role-specialized agents (skeptic always seated), picks a coordination style, and runs a generate-critique-refine loop with an evolving seat registry. [▶ demo](plugins/brainstorm-panel/demo/demo.gif) — a real recorded session. |
